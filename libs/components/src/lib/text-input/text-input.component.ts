...
// import { MentionsConfig } from '@renwu/mentions';
...
@Component({
  selector: 'rw-text-input',
  standalone: true,
  imports: [RwIconComponent, FormsModule],
  templateUrl: './text-input.component.html',
  styleUrl: './text-input.component.scss',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => RwTextInputComponent),
      multi: true,
    },
  ],
  ...
  implements OnInit, OnDestroy, ControlValueAccessor
{
  ...
  @Output()
  enter = new EventEmitter<{ target: RwTextInputComponent }>();
